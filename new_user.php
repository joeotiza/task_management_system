				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="phone_no" class="form-control form-control-sm" required value="<?php echo isset($phone_no) ? $phone_no : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">Department</label>
							<input type="text" name="department" class="form-control form-control-sm" required value="<?php echo isset($department) ? $department : '' ?>">
						</div>
