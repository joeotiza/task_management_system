			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					while($row= $qry->fetch_assoc()):
						...
						$transl = get_html_translation_table(HTML_ENTITIES,ENT_QUOTES);
						unset($transl["\""], $transl["<"], $transl[">"], $transl["<h2"]);
						$areas = strtr(html_entity_decode($row['areas']),$transl);
						$areas=str_replace(array("<li>","</li>"), array("",", "), $areas);
					...
					<tr>
						...
						<td><b><?php echo ($row['town']) ?></b></td>
						<td>
							<p><b><?php echo ucwords($row['location']) ?></b></p>
							<p class="truncate"><?php echo strip_tags($areas) ?></p>
						</td>
