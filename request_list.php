	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_request"><i class="fa fa-plus"></i> Make New Request</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_item" href="./index.php?page=view_item&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">View</a>
