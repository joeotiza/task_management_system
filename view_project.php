					...
					<div class="row">
						<div class="col-sm-6">
							<dl>
								...
								<dt><b class="border-bottom border-primary">Plan</b></dt>
								<dd><?php echo html_entity_decode($plan) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">Town</b></dt>
								<dd><?php echo($town) ?></dd>
							</dl>
							<dl>
							...
							<dl>
								<dt><b class="border-bottom border-primary">Areas</b></dt>
								<dd><?php echo($areas) ?></dd>
							</dl>
						</div>
						<div class="col-md-6">
							<dl>
							...
							<dl>
								<dt><b class="border-bottom border-primary">Design</b></dt>
								<dd><?php echo($design) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">BOQ</b></dt>
								<dd><?php echo($boq) ?></dd>
							</dl>
							<dl>
					...
					<table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							...
							while($row=$tasks->fetch_assoc()):
								...
								$desc = strtr(html_entity_decode($row['plan']),$trans);
