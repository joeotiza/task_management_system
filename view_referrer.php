...
if(isset($_GET['id'])){
	...
	$qry = $conn->query("SELECT * FROM referrer where id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
}
...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      <div class="widget-user-header bg-dark">
        <h3 class="widget-user-username"><?php echo ucwords($fullname) ?></h3>
        <h5 class="widget-user-desc"><?php echo $phone ?></h5>
      </div>
