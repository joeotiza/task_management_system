	...
	<div class="card card-outline card-primary">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="town" value="<?php echo isset($town) ? $town : '' ?>">
				</div>
			</div>
          	<div class="col-md-6">
			  <div class="form-group">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="budget" value="<?php echo isset($budget) ? $budget : '' ?>">
				</div>
			</div>
          	<div class="col-md-6">
			  <div class="form-group">
					<label for="" class="control-label">Design</label>
					<input type="text" class="form-control form-control-sm" name="design" value="<?php echo isset($design) ? $design : '' ?>">
				</div>
			</div>
		</div>
        <div class="row">
      ...
      <?php endif; ?>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					...
					<textarea name="plan" id="" cols="30" rows="10" class="summernote form-control">
						<?php echo isset($plan) ? $plan : '' ?>
					</textarea>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					<label for="" class="control-label">Areas</label>
					<textarea name="areas" id="" cols="30" rows="10" class="summernote form-control">
						<?php echo isset($areas) ? $areas : '' ?>
					</textarea>
				</div>
			</div>
		</div>
